...
def parse_args():
    ...
    parser.add_argument('--n_way', type=int, default=10, help='number of object classes to learn')
    ...
    parser.add_argument('--dimension', type=int, default=100, help='the dimension of dataset(especially genes')
    parser.add_argument('--hidden_size1', type=int, default=200, help='the dimension of dataset')
    parser.add_argument('--hidden_size2', type=int, default=300, help='the dimension of dataset')
    ...
    parser.add_argument('--num_grad_steps_inner', type=int, default=4, help='number of gradient steps in inner loop (during training)')
    ...
    parser.add_argument('--num_context_params', type=int, default=50, help='number of context parameters')
    parser.add_argument('--context_in', nargs='+', default=[False, False, True, True,False], help='per layer, indicate if context params are added')
    ...
    parser.add_argument('--data_path', type=str, default='/home/member/xywang/WORKSPACE/MaryGUO/cavia/classification/data/miniimagenet/', help='folder which contains image data')
